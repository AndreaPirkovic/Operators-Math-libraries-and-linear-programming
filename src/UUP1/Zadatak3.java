...
public class Zadatak3 { 
	public static void main(String[] args) throws Exception { BufferedReader ulaz = new 
	...
	System.out.print("Unesite vrednost za s: "); int s = Integer.parseInt(ulaz.readLine()); 
